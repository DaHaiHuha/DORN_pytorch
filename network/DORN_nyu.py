...
class FullImageEncoder(nn.Module):
    def __init__(self):
        ...
        self.upsample = nn.UpsamplingBilinear2d(size=(46, 81))  # size=(33, 45))  # KITTI 49X65 NYU 33X45
    ...
    def forward(self, x):
        ...
        print("_---------------------------------------------__")
        print("fuck shapes", x1.size(), x2.size(), x3.size(), x4.size(), x5.size())
        print("_---------------------------------------------__")
